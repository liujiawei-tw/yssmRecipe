...
public class RecipeVersionController {
    ...
    public RecipeVersionResponse update(@PathVariable Long id, @Valid @RequestBody RecipeVersionUpsertRequest request) {
        return recipeVersionService.update(id, request);
    }
